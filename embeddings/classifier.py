...
def main(input_file: str, output_csv: str):
    ...
    for _ in range(48):
        ...
        for epoch in range(20):
            ...
            eval_accuracy = (output.argmax(dim=-1) == eval_y).sum().item() / len(
                eval_tasks
            )
            ...
            with open(output_csv, "a") as file:
                file.write(
                    f"{input_file},{epoch},{train_loss},{train_accuracy},{eval_loss},{eval_accuracy}\n"
                )
            # wandb.log(
            #     {
...
if __name__ == "__main__":
    ...
    output_csv = "C:\\Users\\Sander\\Documents\\Courses\\2022-2023\\Afstuderen\\Logs\\classifier\\progress-filled.csv"
    with open(output_csv, "wt") as csv_file:
        csv_file.write(
            "file,z/env_steps,metrics/train_loss,metrics/train_accuracy,metrics/eval_loss,metrics/eval_accuracy\n"
        )
    for file in files:
