...
# Call your script
srun python $project_path/main.py --cfg $project_path/configs/meta/maze/directions.yml --seed $2 --task_file /scratch/sajvanleeuwen/embeddings/all_directions/$3 --render_mode null --num_cpus 16
