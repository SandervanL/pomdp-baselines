...
echo "Train-test split $3, Seed $2"

# Call your script
srun python $project_path/main.py --cfg $project_path/configs/meta/maze/pretrain.yml --seed $2 --split $3 --render_mode null --num_cpus 48
