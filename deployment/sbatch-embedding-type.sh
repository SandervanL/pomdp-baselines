...
# Call your script
srun python $project_path/main.py --cfg $project_path/configs/meta/maze/embedding_type.yml --seed $2 --task_file $project_path/embeddings/embeddings/one_direction/$3 --render_mode null
