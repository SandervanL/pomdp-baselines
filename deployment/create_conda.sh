...
python -m pip install gymnasium torch torchvision torchaudio matplotlib ruamel.yaml absl-py tensorboardX scikit-learn seaborn psutil dill tensorboard wandb
