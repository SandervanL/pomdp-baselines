...
# Call your script
srun python $project_path/main.py --cfg $project_path/configs/meta/maze/embedding_consumption.yml --seed $4 --embedding_obs_init $2 --embedding_rnn_init $3 --render_mode null --num_cpus 16
