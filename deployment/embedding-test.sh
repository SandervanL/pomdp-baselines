...
#SBATCH --cpus-per-task=2     # usually recommended in powers of 2 or divisible by 2
...
echo "Obs init $2, RNN init $3, Seed $4"

# Call your script
srun python $project_path/main.py --cfg $project_path/configs/meta/maze/embedding.yml --seed $4 --embedding_obs_init $2 --embedding_rnn_init $3 --render_mode null
