...
"C:\Program Files\7-zip\7z.exe" a -tzip %destination% "%batchPath%\.." "%batchPath%\..\deployment" -mx0 -xr!logs* -xr!__pycache__ -xr!data -xr!.git -xr!wandb -xr!.idea -xr!*.json
...
set target_dir=embedding-consumption
