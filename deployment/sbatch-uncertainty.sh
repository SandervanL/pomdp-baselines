...
echo "Uncertainty $3, Seed $2"

# Call your script
srun python $project_path/main.py --cfg $project_path/configs/meta/maze/uncertainty.yml --seed $2 --uncertainty_scale $3 --render_mode null --num_cpus 16
