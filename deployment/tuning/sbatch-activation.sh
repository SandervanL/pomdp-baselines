...
echo "Activation $3, Seed $2"

# Call your script
srun python $project_path/main.py --cfg $project_path/configs/meta/maze/activation.yml --seed $2 --embedding_grad $3 --render_mode null --num_cpus 48
