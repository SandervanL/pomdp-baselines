...
# Call your script
srun python $project_path/main.py --cfg $project_path/configs/meta/maze/dilution.yml --seed $2 --task_file /scratch/sajvanleeuwen/embeddings/one_direction/$3 --render_mode null --num_cpus=48
